<footer class="w-11/12 mx-auto h-18 bg-indigo-700 text-center nav flex flex-col justify-around items-center py-3 rounded-lg shadow-lg my-3">
  <p class="text-2xl">© 2023 Corrupted. Made with ❤️ by Silvereen Network</p>
  <div class="flex justify-center space-x-4 text-lg">
    <a href="/terms-of-service" class="duration-150 hover:opacity-25">Terms of Service</a>
